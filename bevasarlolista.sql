...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2024. Már 13. 09:11
...
--
-- Tábla szerkezet ehhez a táblához `bevasarlolista_`
--

CREATE TABLE `bevasarlolista_` (
  `id` int(11) NOT NULL,
  `category` varchar(32) COLLATE utf8_hungarian_ci NOT NULL,
  `productname` varchar(32) COLLATE utf8_hungarian_ci NOT NULL,
  `price` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_hungarian_ci;

--
-- A tábla adatainak kiíratása `bevasarlolista_`
--

INSERT INTO `bevasarlolista_` (`id`, `category`, `productname`, `price`) VALUES
...
--
-- Tábla szerkezet ehhez a táblához `hozzaad_`
--

CREATE TABLE `hozzaad_` (
  `id` int(11) NOT NULL,
...
--
-- A tábla indexei `bevasarlolista_`
--
ALTER TABLE `bevasarlolista_`
  ADD PRIMARY KEY (`id`);

--
-- A tábla indexei `hozzaad_`
--
ALTER TABLE `hozzaad_`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT a táblához `bevasarlolista_`
--
ALTER TABLE `bevasarlolista_`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=101;

--
-- AUTO_INCREMENT a táblához `hozzaad_`
--
ALTER TABLE `hozzaad_`
